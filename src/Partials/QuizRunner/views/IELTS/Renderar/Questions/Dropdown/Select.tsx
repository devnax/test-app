...
const Select = (props: SelectProps) => {
   ...
   const { options, value, onChange, placeholder, error, active } = props
   ...
   return (
      <div>
         <Stack
            ...
            border={1}
            borderColor={error ? "rgb(105, 11, 0)" : "rgb(3, 112, 167)"}
            bgcolor={error ? "rgb(255, 143, 130)" : (active ? "#ddf3fd" : "#fff")}
            borderRadius="2.3px"
            display="inline-flex"
            minWidth={80}
